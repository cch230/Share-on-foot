...
import com.example.shareonfoot.closet.closet_activities.TabFragment_Clothes_inClosetShare;
                        ...
                        try {
                            ...
                            if(result.equals("id")) {
                                ...
                                if("ok".equals(res)){
                                    ...
                                    if("ok".equals(res)){
                                         intent = new Intent(getApplicationContext(), activity_signup_next.class);
                                        intent.putExtra("userID", userID);
                                        startActivity(intent);
                                        return;
                                    }
